...
<body>
    <div class="container">
        <h2>Usted ha elegido un(a) <?php echo ucfirst($tipo); ?></h2>
        <p><strong>Contenido:</strong> <?php echo htmlspecialchars($descripcionActual); ?></p>
        
        <label for="comentario">Escriba su comentario o sugerencia:</label>
