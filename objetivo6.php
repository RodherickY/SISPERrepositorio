                    ...
                    while ($rowMedida = mysqli_fetch_assoc($resultMedidas)) {
                        ...
                        if (!$objetivoImpreso) {
                            ...
                            echo "<td rowspan='$totalFilas'>{$descripcionObjetivo} 
                                    <a href='sugerenciaobjetivo6.php?tipo=objetivo&id=$idObjetivo'>
                        ...
                        if ($primeraFilaResultado) {
                            echo "<td rowspan='{$rowspanResultado[$idResultado]}'>{$descripcionResultado}
                                  <a href='sugerenciaobjetivo6.php?tipo=resultado&id=$idResultado'><img src='img/lapiz.jpg' alt='Editar' style='width: 16px; height: auto;'></a></td>";
                            $primeraFilaResultado = false;
                        }
                        
                        if ($primeraFilaPolitica) {
                            echo "<td rowspan='{$rowspanPolitica[$idPolitica]}'>{$descripcionPolitica}
                                  <a href='sugerenciaobjetivo6.php?tipo=politica&id=$idPolitica'><img src='img/lapiz.jpg' alt='Editar' style='width: 16px; height: auto;'></a></td>";
                            $primeraFilaPolitica = false;
                        }
                        
                        echo "<td>{$rowMedida['descripcion']}
                              <a href='sugerenciaobjetivo6.php?tipo=medida&id={$rowMedida['idmedida']}'><img src='img/lapiz.jpg' alt='Editar' style='width: 16px; height: auto;'></a></td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr>";
