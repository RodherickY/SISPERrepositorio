...
$idObjetivo = 4; // ID del objetivo fijo para este archivo
...
<body>
    <center>
        ...
        <h5>Haz clic en el ícono <img src="img/lapiz.jpg" style="width: 20px; height: auto;">, ubicado en cada medida, política o resultado para editarlo</h5>
    </center>
    <br>
    <center>
        <h4>OBJETIVO N° 4</h4>
                    ...
                    while ($rowMedida = mysqli_fetch_assoc($resultMedidas)) {
                        ...
                        if (!$objetivoImpreso) {
                            ...
                            echo "<td rowspan='$totalFilas'>{$descripcionObjetivo} 
                                    <a href='editarobjetivos.php?tipo=objetivo&id=$idObjetivo'>
                        ...
                        if ($primeraFilaResultado) {
                            echo "<td rowspan='{$rowspanResultado[$idResultado]}'>{$descripcionResultado}
                                  <a href='editarobjetivos.php?tipo=resultado&id=$idResultado'><img src='img/lapiz.jpg' alt='Editar' style='width: 16px; height: auto;'></a></td>";
                            $primeraFilaResultado = false;
                        }
                        
                        if ($primeraFilaPolitica) {
                            echo "<td rowspan='{$rowspanPolitica[$idPolitica]}'>{$descripcionPolitica}
                                  <a href='editarobjetivos.php?tipo=politica&id=$idPolitica'><img src='img/lapiz.jpg' alt='Editar' style='width: 16px; height: auto;'></a></td>";
                            $primeraFilaPolitica = false;
                        }
                        
                        echo "<td>{$rowMedida['descripcion']}
                              <a href='editarobjetivos.php?tipo=medida&id={$rowMedida['idmedida']}'><img src='img/lapiz.jpg' alt='Editar' style='width: 16px; height: auto;'></a></td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr>";
